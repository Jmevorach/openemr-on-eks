...
module "eks" {
  ...
  version = "21.3.1"  # Latest stable version with Auto Mode support

  # Cluster identification and version configuration
  name               = var.cluster_name             # EKS cluster name
  kubernetes_version = var.kubernetes_version       # Kubernetes version (default: 1.33)
...
resource "aws_eks_addon" "metrics_server" {
  ...
  addon_version               = "v0.8.0-eksbuild.2"                # Stable version for Kubernetes 1.33
...
resource "aws_eks_addon" "efs_csi_driver" {
  ...
  addon_version               = "v2.1.12-eksbuild.1"               # Stable version for Kubernetes 1.33
  resolve_conflicts_on_create = "OVERWRITE"                        # Overwrite any existing conflicts
  resolve_conflicts_on_update = "OVERWRITE"                        # Overwrite any existing conflicts
